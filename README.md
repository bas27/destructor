## Destructuring (Домашнее задание к лекции «Object, Reflection и Proxy») [![Build status](https://ci.appveyor.com/api/projects/status/ls09akt77brvtf5a?svg=true)](https://ci.appveyor.com/project/bas27/fpyajs-destructor)
